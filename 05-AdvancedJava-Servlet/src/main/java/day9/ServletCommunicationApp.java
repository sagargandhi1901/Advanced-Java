...
@WebServlet("/register")
public class ServletCommunicationApp extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// user age if less than 18 or greater than 30 not eligible for recruiting
		if (uage < 19 || uage > 30) {
			response.sendError(504, "User Age is not sufficent for this Recruitement");
		} else {
			// otherwise, student is eligible for recruiting
